...
import br.com.casa.repositories.ProdutoRepository;
	...
	public class DevInstantiateDB {
		...
		/***
		 * Instancia a base de dados em ambiente não produtivo
		 * */
		public boolean instantiateDEVConfiguration() throws ParseException {
			...
			Cliente cli1 = new Cliente(null, "Maria Silva", "remi_lebeu@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA);
			 cli1 = cli1.senha(pe.encode("123"));
			cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
			
			Cliente cli2 = new Cliente(null, "Vanderson nogueira", "vanderson.01@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA);
			cli2 = cli2.senha(pe.encode("123"));
